    ...
    <section className={`${styles.paddings}flex justify-center items-center flex-col`}>
      <div className="xl:flex justify-center items-center relative xl:space-x-120">
        ...
        >
          ...
          <div className="xl:w-[259px] xl:h-[510px] xl:pt-20 md:pt-20 mt-20">
            <TypingText
...
"
          ...
          <motion.div variants={fadeIn("up", "tween", 0.05, 0.25)} className={`flex-1 ${styles.flexCenter}`}>
            <div className="relative">
              <img
                ...
                alt="bedroom"
                className="xl:w-[950px] xl:h-[677px] xl:pt-0 md:w-[550px] md:h-[177px] xl:mt-10 pt-10 object-contain"
              />
              <div className="absolute bottom-10 left-10 flex items-start justify-end w-full h-full">
                <img
                  src="LUXE_Design.png"
                  alt="bedroom"
                  className="xl:w-[177.76px] xl:h-[238.41px] xl:mr-0 md:w-[67.76px] h-[160.41px] mr-8 mt-5 object-contain"
                />
              </div>
            </div>
          </motion.div>
      ...
      <div className="xl:flex justify-center items-center relative xl:space-x-120">
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: false, amount: 0.25 }}
          className={"flex justify-center items-center flex-col xl:pt-20 mt-20 md:pt-20"}
        >
          <motion.div variants={fadeIn("up", "tween", 0.05, 0.25)} className={`flex-1 ${styles.flexCenter}`}>
            <img
        ...
        >
          <motion.div variants={planetVariants("right")} className={`flex-1 ${styles.flexCenter} xl:mt-20 xl:pt-20`}>
            <img src="LOGO-outdoor.png" alt="LOGO_bedroom" className="xl:w-[152.5px] xl:h-[90.85px] xl:mt-20 md:w-[130.5px] h-[70.85px] mt-20 object-contain" />
          </motion.div>
