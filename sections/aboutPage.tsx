        ...
        <section className={`${styles.paddings}flex justify-center items-center flex-col relative z-10`}>
            ...
            >
                ...
                <motion.p variants={fadeIn('up', 'tween', 0.2, 1)} className="mt-[8px] freightBigPro sm:text-[24px] text-[20px] text-center text-secondary-white">
                    Showcasing streamlined sophistication and the latest trends in open plan architectural design, these 8 exemplary homes deliver executive
                    standards and abundant lifestyles. Balance leafy tranquility with a seamless city connection at this unrivalled location.
