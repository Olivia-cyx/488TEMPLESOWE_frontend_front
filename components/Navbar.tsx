  ...
  return (
    ...
    >
      <div className={`${styles.innerWidth} flex justify-between gap-4`}>
        ...
        <h2
          className={`Freight Big Pro text-[21px]  pt-4 cursor-pointer hover:underline ${active === "ABOUT" ? "underline" : ""}`}
        ...
        <h2
          className={`Freight Big Pro text-[21px]  pt-4 cursor-pointer hover:underline ${active === "LIFESTYLE" ? "underline" : ""}`}
          style={{ color: "#DCD5C6", fontWeight: "lighter" }}
        ...
        <h2
          className={`Freight Big Pro text-[21px]  pt-4 cursor-pointer hover:underline ${active === "GALLERY" ? "underline" : ""}`}
          style={{ color: "#DCD5C6", fontWeight: "lighter" }}
        ...
        <h2
          className={`Freight Big Pro text-[21px]  pt-4 cursor-pointer hover:underline ${active === "TEAM" ? "underline" : ""}`}
          style={{ color: "#DCD5C6", fontWeight: "lighter" }}
